...
namespace Game.Facade
{
    ...
    public abstract class UCPageBase:Page
    {
        ...
        /// 网站外观
        /// </summary>
        protected GameWebFacade aideWebsiteFacade;
...
//             }
       ...
       /// <param name="e"></param>
        ...
        {
            return this.aideUserFacade.GetUserBaseInfoByUserID(this.userTicket.UserID);
        }
        ...
        public string GetAccountsByUserID(int userID)
        {
            ...
            //return aideUserFacade.GetAccountInfoByUserID(userID).Accounts == "" ? "匿名" : aideUserFacade.GetAccountInfoByUserID(userID).Accounts;
        }
        ...
        {
            UserInfo user = aideUserFacade.GetAccountInfoByUserID(userTicket.UserID);
