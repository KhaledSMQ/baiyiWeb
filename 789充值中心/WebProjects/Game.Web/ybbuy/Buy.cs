...
namespace Game.Web.Pay.YbBuy
{
    ...
    public abstract class Buy
    {
        ...
        //支付的请求地址
        private static string nodeAuthorizationURL = ConfigurationManager.AppSettings["yeepayPayUrl"];

        //查询退款的请求地址
        private static string queryRefundReqURL = ConfigurationManager.AppSettings["yeepayRefundUrl"];
        ...
        ///// <returns></returns>
        //public static ICCBuyRefundOrdResult RefundOrd(string pb_TrxId, string p3_Amt, string p4_Cur, string p5_Desc)
        //{
        //    string sbOld = "";
        ...
        //    if (hmac == nhmac)
        //    {
        //        ICCBuyRefundOrdResult result = new ICCBuyRefundOrdResult(r0_Cmd, r1_Code, r2_TrxId, r3_Amt,
        //       r4_Cur, hmac, "");
        //        return result;
        //    }
        //    else
