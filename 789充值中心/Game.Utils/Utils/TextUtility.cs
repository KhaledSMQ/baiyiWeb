namespace Game.Utils
{
    ...
    public class TextUtility
    {
        ...
        public static string AddFirst(string originalVal, string firstStr)
        {
            if (originalVal.StartsWith(firstStr))
            {
                return originalVal;
            }
            return (firstStr + originalVal);
        }
        ...
        public static DateTime DayOfMonth(DateTime oneDateTime, bool isFirstDay)
        {
            DateTime time = new DateTime(oneDateTime.Year, oneDateTime.Month, 1);
            if (isFirstDay)
            {
                return time;
            }
        ...
        public static DateTime DayOfQuarter(DateTime oneDateTime, bool isFirstDay)
        {
            int month = 0;
            switch (oneDateTime.Month)
            {
                case 1:
                case 2:
                case 3:
            ...
            DateTime time = new DateTime(oneDateTime.Year, month, 1);
            if (isFirstDay)
            {
                return time;
            }
            return time.AddMonths(3).AddDays(-1.0);
        }

        public static DateTime DayOfYear(DateTime oneDateTime, bool isFirstDay)
        {
            DateTime time = new DateTime(oneDateTime.Year, 1, 1);
            if (isFirstDay)
            {
                return time;
            }
        ...
        public static string DeleteFirst(string originalVal, string firstStr)
        {
            string str;
            if (string.IsNullOrEmpty(originalVal))
            {
            ...
            if (originalVal.StartsWith(firstStr))
            {
                str = originalVal.Substring(firstStr.Length, originalVal.Length - 1);
            }
            else
            {
                str = originalVal;
        ...
        public static string DeleteLast(string originalVal, string lastStr)
        {
            string str;
            if (string.IsNullOrEmpty(originalVal))
            {
            ...
            if (originalVal.EndsWith(lastStr))
            {
                str = originalVal.Substring(0, originalVal.Length - lastStr.Length);
            }
            else
            {
                str = originalVal;
        ...
        public static int DiffDateAddHours(DateTime oneDateTime, int hours)
        {
            TimeSpan span = (TimeSpan) (DateTime.Now - oneDateTime.AddHours((double) hours));
        ...
        public static int DiffDateAddHours(string oneDateTime, int hours)
        {
            if (string.IsNullOrEmpty(oneDateTime))
            {
                return 0;
            }
            return DiffDateAddHours(DateTime.Parse(oneDateTime), hours);
        }

        public static int DiffDateAddMinutes(DateTime oneDateTime, int minutes)
        {
            TimeSpan span = (TimeSpan) (DateTime.Now - oneDateTime.AddMinutes((double) minutes));
        ...
        public static int DiffDateAddMinutes(string oneDateTime, int minutes)
        {
            if (string.IsNullOrEmpty(oneDateTime))
            {
                return 0;
            }
            return DiffDateAddMinutes(DateTime.Parse(oneDateTime), minutes);
        }

        public static int DiffDateAddSeconds(DateTime oneDateTime, int seconds)
        {
            TimeSpan span = (TimeSpan) (DateTime.Now - oneDateTime.AddSeconds((double) seconds));
        ...
        public static int DiffDateAddSeconds(string oneDateTime, int seconds)
        {
            if (string.IsNullOrEmpty(oneDateTime))
            {
                return 0;
            }
            return DiffDateAddSeconds(DateTime.Parse(oneDateTime), seconds);
        }
        ...
        public static string HtmlDecode(string originalStr)
        {
        ...
        public static string HtmlEncode(string originalStr)
        {
        ...
        public static string ToSChinese(string tcStr)
        {
            return Strings.StrConv(tcStr, VbStrConv.SimplifiedChinese, 0);
        }

        public static string ToTChinese(string scStr)
        {
            return Strings.StrConv(scStr, VbStrConv.TraditionalChinese, 0);
        }
