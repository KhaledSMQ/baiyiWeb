namespace Game.Utils
{
    ...
    public class Utility
    {
        ...
        public static string ConvetVersionInt2Str(int dwVersion)
        {
            if (dwVersion <= 0)
            {
                return "0.0.0.0";
            ...
            buffer += (dwVersion >> 0x18) + ".";
            buffer += (((dwVersion >> 0x10) << 0x18) >> 0x18) + ".";
            buffer += (((dwVersion >> 8) << 0x18) >> 0x18) + ".";
            buffer += (dwVersion << 0x18) >> 0x18;
