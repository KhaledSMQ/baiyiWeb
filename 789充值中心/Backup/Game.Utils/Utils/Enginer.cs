...
　　        };
        ...
        public string SearchKey(string myString)
        {
            ...
            if (_EngineName != "")
            {
                ...
                System.Text.RegularExpressions.Match matche = myReg.Match(myString);
        ...
        {
            string[] strArray = new string[] { "Google", "Baidu", "yisou", "MSN", "Yahoo", "live", "tom", "163", "TMCrawler", "iask", "Sogou", "soso", "youdao", "zhongsou", "3721", "so", "openfind", "alltheweb", "lycos", "bing", "118114" };
            str = str.ToLower();
