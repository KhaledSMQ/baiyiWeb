...
namespace Game.Entity.Treasure
{
	...
	public partial class RecordInsure  
	{
		...
		private decimal m_sourceGold;		//当前金币数目
		private decimal m_sourceBank;		//当前银行数目
		private int m_targetUserID;			//目标用户ID
		private decimal m_targetGold;		//当前金币数目
		private decimal m_targetBank;		//当前银行数目
		private decimal m_swapScore;		//流通金币数目
		private decimal m_revenue;			//税收数目
