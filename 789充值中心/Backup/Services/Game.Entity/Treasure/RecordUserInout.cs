...
namespace Game.Entity.Treasure
{
	...
	public partial class RecordUserInout  
	{
		...
		private decimal m_enterScore;			//进入积分
		private decimal m_enterInsure;			//
		private decimal m_enterUserMedal;		//进入幸运币
		...
		private decimal m_score;				//变更积分
		private decimal m_insure;				//银行记录
		private decimal m_revenue;				//变更税收
		private int m_winCount;					//胜局变更
		private int m_lostCount;				//输局变更
		private int m_drawCount;				//和局变更
		private int m_fleeCount;				//逃局变更
		private decimal m_userMedal;			//变化幸运币
